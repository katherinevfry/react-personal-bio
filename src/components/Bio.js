  ...
  return (
    <BioDiv>
      ...
      <InnerDiv>
        ...
        <TextDiv>
          <p>Hi there! My name is <EmStyled>Katy Fry</EmStyled>. I am a <EmStyled>designer</EmStyled> and <EmStyled>software developer</EmStyled> who calls Nashville, TN home. </p>
          ...
          <p>As a developer, I try to make everything I do both <EmStyled>functional</EmStyled> and <EmStyled>beautiful</EmStyled>.</p>
        </TextDiv>
      </InnerDiv>
    </BioDiv>
  );
